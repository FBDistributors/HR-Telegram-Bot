...
texts = {
    'uz': {
        ...
        # Namuna hujjatlar: kategoriyalar
        'template_categories_title': "📝 Namuna hujjatlar — Kategoriyani tanlang:",
        'no_templates_in_category': "❌ Bu kategoriyada hozircha namuna hujjatlar yo'q.",
        'tmpl_cat_entry_form': "📋 Ishga kirish anketasi",
        'tmpl_cat_dismissal': "🧾 Bo'shatish",
        'tmpl_cat_exit_interview': "🗒️ Ishdan bo'shash oldidan intervyu",
        'tmpl_cat_vacation': "🏖️ Ta'til uchun ariza",
        'tmpl_cat_leave_without_pay': "📅 O'z hisobidan ta'til",
        'back_to_template_categories': "⬅️ Kategoriyalarga qaytish",
        'ask_template_category': "Namuna hujjat uchun kategoriyani tanlang:",
        'ask_debt_excel': "Qarzdorlik uchun Excel (.xlsx) faylni yuboring:",
        'info_category_debt': "💰 Qarzdorlik",
        'debt_documents': "Qarzdorlik hujjatlari",
        'no_debt_documents': "Hozircha qarzdorlik hujjatlari yo'q.",
        ...
        'ask_template_uz_pdf': "PDF faylni yuboring:",
        'ask_template_uz_docx': "O'zbek tilidagi Word (DOCX) faylni yuboring:",
        'ask_template_ru_pdf': "PDF faylni yuboring:",
        ...
        'ask_info_category': "Kategoriyani tanlang:",
...
📊 **Dastlabki baho:** [Mos keladi / O'ylab ko'rish kerak / Tajribasi kam]""",
    ...
    'ru': {
        ...
        # Шаблоны документов: категории
        'template_categories_title': "📝 Шаблоны документов — Выберите категорию:",
        'no_templates_in_category': "❌ В этой категории пока нет шаблонов.",
        'tmpl_cat_entry_form': "📋 Анкета при приеме на работу",
        'tmpl_cat_dismissal': "🧾 Увольнение",
        'tmpl_cat_exit_interview': "🗒️ Выходное интервью",
        'tmpl_cat_vacation': "🏖️ Заявление на отпуск",
        'tmpl_cat_leave_without_pay': "📅 Отпуск без содержания",
        'back_to_template_categories': "⬅️ Вернуться к категориям",
        'ask_template_category': "Выберите категорию для шаблона документа:",
        'ask_debt_excel': "Для задолженности отправьте Excel-файл (.xlsx):",
        'info_category_debt': "💰 Задолженность",
        'debt_documents': "Документы по задолженности",
        'no_debt_documents': "Пока документов по задолженности нет.",
        ...
        'ask_info_category': "Выберите категорию:",
